...
export interface Database {
  public: {
    ...
    Functions: {
      ...
      start_attempt_with_snapshots: {
        Args: { p_assessment_id: string; p_user_id: string; p_question_order: Json; p_max_score: number; p_snapshots: Json }
        Returns: { attempt_id: string; started_at: string; resumed: boolean }[]
      }
      save_attempt_answer_atomic: {
        Args: { p_attempt_id: string; p_user_id: string; p_question_id: string; p_answer: string; p_time_spent_sec: number }
        Returns: { saved_at: string; server_elapsed_sec: number }[]
      }
      upsert_questions_atomic: {
        Args: { p_rows: Json; p_actor: string }
        Returns: number
      }
      update_question_atomic: {
        Args: { p_question: Json; p_actor: string; p_expected_version: number }
        Returns: number
      }
